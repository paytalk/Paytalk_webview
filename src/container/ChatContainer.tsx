        ...
        <c.ChatContainerWrap>
            ...
            {chatDetail ? (
                <ChatTemplate
                    ...
                    ChatName={chat_room_list.data[chatNum].chat_name}
                    chat={chat_room_list.data[chatNum].new_msg}
                />
            ) : (
                ""
            )}
