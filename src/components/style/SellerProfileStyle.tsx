...
export const SellerProfileWrap = styled.div<{ position: any }>`
    position: fixed;
    width: 100vw;
    height: 100vh;
...
export const Btn = styled.div<{ width: any; height: any }>`
...
`;
export const SellerTabLi = styled.li<{ pin: any }>`
    padding: 1vh 0;
    width: 25vw;
    font-family: "Pretendard";
    font-style: normal;
