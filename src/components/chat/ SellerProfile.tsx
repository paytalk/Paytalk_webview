...
const SellerProfile = ({ position, OnClick }: any) => {
        ...
        <s.SellerProfileWrap position={position}>
            ...
            <s.SellerProfileTop>
                ...
                <s.Btn width="8.8889vw" height="8.8889vw">
                    <img
                        style={{ width: "4.4444vw", height: "4.4444vw" }}
                        src={`${BaseURL}` + "/img/link (1).png"}
                        alt="이미지"
                    />
                </s.Btn>
                <s.Btn width="22.2222vw" height="8.8889vw">
                    문의하기
                </s.Btn>
            </s.SellerProfileTop>
            <s.SellerTab>
                ...
                {pin == 0 ? (
                    ...
                    <s.ContentBoxUl>
                        {Store_noti.data.map(index => (
                            <s.NoticeLi>
                                <h3>{index.review_title}</h3>
                                <p>{index.review_lastModified}</p>
                            </s.NoticeLi>
                        ))}
                    </s.ContentBoxUl>
                ) : pin == 2 ? (
                    <s.InfoBox>
                        ...
                        <s.BasicInfo>
                            <p>
                                <span>영업시간</span>
                                {Store_info.data.base_info.running_time}
                            </p>
                            <p>
                                <span>웹사이트</span>
                                {Store_info.data.base_info.store_url}
                            </p>
                            <p>
                                <span>전화번호</span>
                                {Store_info.data.base_info.phone_num}
                            </p>
                        </s.BasicInfo>
                        <s.Gubun></s.Gubun>
                        ...
                        <s.SnsLink>
                            <s.Sns>
                                <s.SnsImg></s.SnsImg>
                                <s.SnsText>
                                    {Store_info.data.social_sns.instagram_id}
                                </s.SnsText>
                            </s.Sns>
                            <s.Sns>
                                <s.SnsImg></s.SnsImg>
                                <s.SnsText>
                                    {Store_info.data.social_sns.urls.url}
                                </s.SnsText>
                            </s.Sns>
                        </s.SnsLink>
                        <s.Gubun></s.Gubun>
                        ...
                        <s.CompanyInfo>
                            <p>
                                <span>법인명</span>
                                {Store_info.data.seller_info.corporate_name}
                            </p>
                            <p>
                                <span>사업자 등록번호</span>
                                {Store_info.data.seller_info.seller_num}
                            </p>
                            <p>
                                <span>업태</span>
                                {Store_info.data.seller_info.business_status}
                            </p>
                            <p>
                                <span>주소</span>
                                {Store_info.data.seller_info.address}
                            </p>
                        </s.CompanyInfo>
                    </s.InfoBox>
                ) : (
                    <s.ContentBoxUl>
                        {Store_review.data.map(index => (
                            <s.ReviewLi>
                                <s.ReviewImg>
                                    <img
                                        src={`${BaseURL}` + index.review_img}
                                        alt="이미지"
                                    />
                                </s.ReviewImg>
                                <s.ReviewerNick>
                                    <p>
                                        <span>{index.review_userId}</span>
                                        {index.review_lastModified}
                                    </p>
                                </s.ReviewerNick>
                                <s.ReviewTitle>
                                    {index.review_title}
