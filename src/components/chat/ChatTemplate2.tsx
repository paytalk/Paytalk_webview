...
const ChatTemplate2 = ({ setChatDetail, ChatName, chat }: any) => {
                ...
                >
                    ...
                    <cc.HistoryUl>
                        <cc.HistoryLi1>
                            <cc.Img>
                                <img
                                    src={`${BaseURL}` + "/img/profile.jpeg"}
                                    alt=""
                                />
                            </cc.Img>
                            <cc.Name>
                                <p>
                                    대성물산<span>님이 보낸 돈</span>
                                </p>
                            </cc.Name>
                            <cc.cost>
                                <p>
                                    <span>400,000원</span> (사십만원)
                                </p>
                            </cc.cost>
                        </cc.HistoryLi1>
                        <cc.HistoryLi2>
                            ...
                            <cc.InfoArea>
                                <cc.StatusArea>
                                    <cc.Status style={{ opacity: "0" }}>
                                        <cc.CheckIcon bgColor=""></cc.CheckIcon>
                                        <span>만료</span>
                                    </cc.Status>
                                    <cc.Status style={{ opacity: "0" }}>
                                        <cc.CheckIcon bgColor=""></cc.CheckIcon>
...
#5D5FEE"
                ...
                <c.ChatArea>
                    <c.ChatSample text="left">
                        ...
                        <c.Chat>
                            주식회사 소셜님께 400,000원 송금이 완료되었습니다
                        </c.Chat>
                    </c.ChatSample>
                </c.ChatArea>
                <c.ChatInputArea>
